// ============================================================================
// build.rs — driver-virtio-net
//
// Emits the linker-script argument for `driver-virtio-net-bin`'s own
// `[[bin]]` link step. Mirrors `subsystems/drivers/driver-virtio-blk/
// build.rs` exactly (see that file's own doc comment for the full
