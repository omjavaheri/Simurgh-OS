...
/// This crate's first real process entry point (riscv64/x86_64 — the
/// two architectures whose "P2 demo parity" milestone has wired it up
/// so far; aarch64 stays a tracked follow-up). See the module's own
/// doc comment.
