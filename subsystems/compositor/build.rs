...
// build.rs — compositor
//
// Emits the linker-script argument for `compositor-bin`'s own `[[bin]]`
// link step. Mirrors `subsystems/vfs-service/fs-native/build.rs` exactly
...
// build of this crate's library — `compositor` is also a normal `rlib`
